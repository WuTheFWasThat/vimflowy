...
describe "text formatting", () ->
  ...
  it "correctly detects cursor style in insert mode", () ->
    t = new TestCase ['']
    t.sendKeys 'i'
    t.sendKeys 'normal, '
  ...
  it "preserves cursor style on next line in insert mode", () ->
    t = new TestCase ['']
    t.sendKeys 'i'
    t.sendKey boldKey
    t.sendKeys 'this'
  ...
  it "works in visual line mode", () ->
    t = new TestCase [ 'blah', 'blah', 'blah']
    t.sendKeys 'Vjj'
    t.sendKey boldKey
    t.expect [
      {
